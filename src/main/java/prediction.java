...
public class prediction
{
	...
	{
		FileWriter fW=new FileWriter(testWekaFile);
		...
		{
			System.out.println("**Ans"+cnt+":"+QA[cnt]);
			System.out.println("Similarity:"+sims.get(cnt-1));
	...
	public static void main(String args[]) throws Exception
	{
		...
		BufferedReader bR=new BufferedReader(new FileReader(testInputFileName));
